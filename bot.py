...
Важно:
- Пиши только то, в чём уверен на 100%
- НЕ упоминай конкретные магазины, ТЦ, кафе или здания — только история улицы или района
- Интересный факт должен быть об истории названия улицы или о районе в целом, не о конкретных объектах

Верни только JSON, без пояснений:
{{
  "name": "точное красивое название места",
  "history": "история этой улицы или района, 2-3 предложения живым языком",
  "fact": "факт об истории названия улицы или о районе, 1-2 предложения — без упоминания конкретных магазинов и зданий"
}}"""
